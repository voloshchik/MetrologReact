...
const AddDevice = ({ addNewDevice, history }) => {
    ...
    return (
        <Fragment>
            ...
            <p className="lead">
            <i class="fa fa-balance-scale" aria-hidden="true"></i> Ввод нового средства измерения
            </p>
            ...
            <form className='form' onSubmit={e => onSubmit(e)}>
                ...
                <div className="form-group">
                    <input type="text" placeholder="period" name="period" value={period} onChange={e => onChange(e)}/>
                </div>
