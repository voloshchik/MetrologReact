      ...
      <Fragment>
        ...
        <section className='container'>
          ...
          <Switch>
            ...
            <PrivateRoute exact path='/check/:id' component={ PutCalibration } />
            <PrivateRoute exact path='/history/:id' component={ CheckHistory } />
            <PrivateRoute exact path='/dashboard' component={ Dashboard } />
            <PrivateRoute exact path='/checktable' component={ CheckTable } />
            <PrivateRoute exact path='/add-device' component={ AddDevice } />
            <PrivateRoute exact path='/update-device/:id' component={ UpdateDevice } />
